...
| description | An optional description of the regional backend security policy | `string` | `"Regional backend security policy"` | no |
...
| name | Name of regional security policy. Name must be 1-63 characters long and match the regular expression a-z? which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash | `string` | `"regional-backend-security-policy"` | no |
...
| Name | Description |
|------|-------------|
| policy | Regional backend security policy created |
