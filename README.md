...
| type | Type indicates the intended use of the security policy. Possible values are CLOUD\_ARMOR, CLOUD\_ARMOR\_EDGE and CLOUD\_ARMOR\_INTERNAL\_SERVICE | `string` | `"CLOUD_ARMOR"` | no |
